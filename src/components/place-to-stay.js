...
import NftImage1 from '../nft/nft1.png'
import NftImage2 from '../nft/nft2.png'
import NftImage3 from '../nft/nft3.png'
import NftImage4 from '../nft/nft4.png'
import NftImage5 from '../nft/nft5.png'
import NftImage6 from '../nft/nft6.png'
import NftImage7 from '../nft/nft7.png'
import NftImage8 from '../nft/nft8.png'
import NftImage9 from '../nft/nft9.png'
import NftImage10 from '../nft/nft10.png'
import NftImage11 from '../nft/nft11.png'
import NftImage12 from '../nft/nft12.png'
import NftImage13 from '../nft/nft13.png'
import NftImage14 from '../nft/nft14.png'
import NftImage15 from '../nft/nft15.png'
import NftImage16 from '../nft/nft16.png'
                        ...
                        <div className='cards'>
                            ...
                            <div className='card nft-card-1'>
                                <div className='nft-card'>
                                    <div className='image'>
                                        <img className='nftimage1' alt='nft ' src={NftImage1}/>
                                        <Heart/>
                                    </div>
                            ...
                            <div className='card nft-card-2'>
                                <div className='nft-card'>
                                    <div className='image'>
                                        <img className='nftimage2' alt='nft ' src={NftImage2}/>
                                        <Heart/>
                                    </div>
                                    <div className='card-txt'>
                                        <div className='left-txt'>
                            ...
                            <div className='card nft-card-3'>
                                <div className='nft-card'>
                                    <div className='image'>
                                        <img className='nftimage3' alt='nft ' src={NftImage3}/>
                                        <Heart/>
                                    </div>
                                    <div className='card-txt'>
                                        <div className='left-txt'>
                            ...
                            <div className='card nft-card-4'>
                                <div className='nft-card'>
                                    <div className='image'>
                                        <img className='nftimage4' alt='nft ' src={NftImage4}/>
                                        <Heart/>
                                    </div>
                                    <div className='card-txt'>
                                        <div className='left-txt'>
                            ...
                            <div className='card nft-card-5'>
                                <div className='nft-card'>
                                    <div className='image'>
                                        <img className='nftimage5' alt='nft ' src={NftImage5}/>
                                        <Heart/>
                                    </div>
                                    <div className='card-txt'>
                                        <div className='left-txt'>
                            ...
                            <div className='card nft-card-6'>
                                <div className='nft-card'>
                                    <div className='image'>
                                        <img className='nftimage6' alt='nft ' src={NftImage6}/>
                                        <Heart/>
                                    </div>
                                    <div className='card-txt'>
                                        <div className='left-txt'>
                            ...
                            <div className='card nft-card-7'>
                                <div className='nft-card'>
                                    <div className='image'>
                                        <img className='nftimage7' alt='nft ' src={NftImage7}/>
                                        <Heart/>
                                    </div>
                                    <div className='card-txt'>
                                        <div className='left-txt'>
                            ...
                            <div className='card nft-card-8'>
                                <div className='nft-card'>
                                    <div className='image'>
                                        <img className='nftimage8' alt='nft ' src={NftImage8}/>
                                        <Heart/>
                                    </div>
                                    <div className='card-txt'>
                                        <div className='left-txt'>
                            ...
                            <div className='card nft-card-9'>
                                <div className='nft-card'>
                                    <div className='image'>
                                        <img className='nftimage9' alt='nft ' src={NftImage9}/>
                                        <Heart/>
                                    </div>
                                    <div className='card-txt'>
                                        <div className='left-txt'>
                            ...
                            <div className='card nft-card-10'>
                                <div className='nft-card'>
                                    <div className='image'>
                                        <img className='nftimage10' alt='nft ' src={NftImage10}/>
                                        <Heart/>
                                    </div>
                                    <div className='card-txt'>
                                        <div className='left-txt'>
                            ...
                            <div className='card nft-card-11'>
                                <div className='nft-card'>
                                    <div className='image'>
                                        <img className='nftimage11' alt='nft ' src={NftImage11}/>
                                        <Heart/>
                                    </div>
                                    <div className='card-txt'>
                                        <div className='left-txt'>
                            ...
                            <div className='card nft-card-12'>
                                <div className='nft-card'>
                                    <div className='image'>
                                        <img className='nftimage12' alt='nft ' src={NftImage12}/>
                                        <Heart/>
                                    </div>
                                    <div className='card-txt'>
                                        <div className='left-txt'>
                            ...
                            <div className='card nft-card-13'>
                                <div className='nft-card'>
                                    <div className='image'>
                                        <img className='nftimage13' alt='nft ' src={NftImage13}/>
                                        <Heart/>
                                    </div>
                                    <div className='card-txt'>
                                        <div className='left-txt'>
                            ...
                            <div className='card nft-card-14'>
                                <div className='nft-card'>
                                    <div className='image'>
                                        <img className='nftimage14' alt='nft ' src={NftImage14}/>
                                        <Heart/>
                                    </div>
                                    <div className='card-txt'>
                                        <div className='left-txt'>
                            ...
                            <div className='card nft-card-15'>
                                <div className='nft-card'>
                                    <div className='image'>
                                        <img className='nftimage15' alt='nft ' src={NftImage15}/>
                                        <Heart/>
                                    </div>
                                    <div className='card-txt'>
                                        <div className='left-txt'>
                            ...
                            <div className='card nft-card-16'>
                                <div className='nft-card'>
                                    <div className='image'>
                                        <img className='nftimage16' alt='nft ' src={NftImage16}/>
                                        <Heart/>
                                    </div>
                                    <div className='card-txt'>
                                        <div className='left-txt'>
